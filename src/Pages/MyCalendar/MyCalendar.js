...
export default function MyCalendar(){
    ...
    return(
        <>
            ...
            <h6 className="text-muted">Note for the frontend dev: You are in the MyCalendar/Attendance Overview page. Please work on me. Kindly refer to the figma link below to see the "general" look or functionality of this page.</h6>
