...
export default function MyCalendar(){
    ...
    return(
        <>
            ...
            <h6 className="text-muted">Note for the frontend dev: You are in the MyCalendar/Attendance Overview page. Please work on me. Kindly refer to this figma link to see how this page is supposed to look like.</h6>
